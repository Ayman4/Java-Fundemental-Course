...
public class BouncingBallSimple extends JPanel {
   ...
   private float ballSpeedX = 1;   // Ball's speed for x and y
         ...
         public void run() {
            while (true) { // Execute one update step
               // Calculate the ball's new position
                //VIP Line as it update the new locations for the ball
               ballX += ballSpeedX;
               ballY += ballSpeedY;
               ...
               if (ballX - ballRadius < 0) {
                  ...
                  ballRadius+=10; //This line will increease the ball radius when it hits the left border
